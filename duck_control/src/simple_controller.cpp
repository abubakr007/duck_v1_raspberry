#include "duck_control/simple_controller.hpp"
                                  ...
                                  , theta_(0.0)
{
    ...
    vel_sub_ = create_subscription<geometry_msgs::msg::TwistStamped>("/duck_control/cmd_vel", 10, std::bind(&SimpleController::velCallback, this, _1));
    ...
    odom_pub_ = create_publisher<nav_msgs::msg::Odometry>("/duck_control/odom", 10);
